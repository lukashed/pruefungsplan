...
Notifies you when the Pruefungsplan becomes available.
...
.. code-block:: bash
    ...
    heroku run python pruefungsplan/manage.py syncdb --noinput --settings=config.settings
    heroku run python pruefungsplan/manage.py migrate --settings=config.settings
    heroku run python pruefungsplan/manage.py collectstatic --settings=config.settings
